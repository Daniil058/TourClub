...
namespace EquipmentStorage.Migrations
{
    ...
    [Migration("20231228014304_MyAwesomeMigration7")]
    partial class MyAwesomeMigration7
    {
            ...
            modelBuilder.Entity("EquipmentStorage.Data.Models.Interest", b =>
                {
                    ...
                    b.HasIndex("UserInterestId")
                        .HasDatabaseName("ix_interests_user_interest_id");
            ...
            modelBuilder.Entity("EquipmentStorage.Data.Models.UserDescription", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_descriptions");

                    b.HasIndex("RoleId")
                        .HasDatabaseName("ix_user_descriptions_role_id");

                    b.ToTable("user_descriptions");
                });
            ...
            modelBuilder.Entity("EquipmentStorage.Data.Models.Booking", b =>
                {
                    ...
                    b.HasOne("EquipmentStorage.Data.Models.UserDescription", "User")
                        ...
                        .HasConstraintName("fk_booking_user_descriptions_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EquipmentStorage.Data.Models.Interest", b =>
                {
                    b.HasOne("EquipmentStorage.Data.Models.UserInterest", null)
                        ...
                        .HasConstraintName("fk_interests_user_interests_user_interest_id");
                });
            ...
            modelBuilder.Entity("EquipmentStorage.Data.Models.UserDescription", b =>
                {
                    b.HasOne("EquipmentStorage.Data.Models.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .HasConstraintName("fk_user_descriptions_role_role_id");
            ...
            modelBuilder.Entity("InterestUserDescription", b =>
                {
                    b.HasOne("EquipmentStorage.Data.Models.Interest", null)
                        ...
                        .HasConstraintName("fk_interest_user_description_interests_interests_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("EquipmentStorage.Data.Models.UserDescription", null)
                        ...
                        .HasConstraintName("fk_interest_user_description_user_descriptions_users_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
